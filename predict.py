...
def parse_arguments():
    ...
    parser.add_argument('--device', choices=['cpu'], required=False, help='If not specified cuda device is used if available')
...
if __name__ == '__main__':
    ...
    # datasets = generate_datasets(suffix='15_equal', type='unpaired', train=False, test=True)
