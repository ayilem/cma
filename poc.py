...
checkpoint_modality1 = torch.load('C:/Users/emend/3A_new/3A_new/Projet 3A/cma/checkpoint/vae_0_epoch_50.pth', map_location=torch.device('cpu'))
checkpoint_modality2 = torch.load('C:/Users/emend/3A_new/3A_new/Projet 3A/cma/checkpoint/vae_1_epoch_50.pth', map_location=torch.device('cpu'))
checkpoint_modality3 = torch.load('C:/Users/emend/3A_new/3A_new/Projet 3A/cma/checkpoint/vae_2_epoch_50.pth', map_location=torch.device('cpu'))
